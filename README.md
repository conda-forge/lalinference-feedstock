...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lalinference-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lalinference-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add lalinference lalinference-data liblalinference python-lalinference
# for installing globally
pixi global install lalinference lalinference-data liblalinference python-lalinference
```
...
It is possible to list all of the versions of `lalinference` available on your platform:
...
```
pixi search lalinference --channel conda-forge
```
